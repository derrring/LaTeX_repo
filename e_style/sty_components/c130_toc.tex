...
\renewcommand{\tableofcontents}{%
    ...
    \ifcsdef{chapter}{%
        ...
        \etocsettocstyle{%
            ...
            \vskip0.3\baselineskip\parindent0em
        }{%
...
% Local (chapter-level) TOC: call \setuplocaltoc then \localtableofcontents.
% \localtableofcontents is etoc-native, unaffected by our \tableofcontents override.
\newcommand{\setuplocaltoc}{%
    ...
    }{\rule{\linewidth}{1pt}\vspace{0.5\baselineskip}}%
}

% NOTE: \setuplocaltoc must NOT be called here at load time.
% It sets a global etocsettocstyle that suppresses the TOC title,
% which breaks \tableofcontents and \mytoc if called before them.
% Users should call \setuplocaltoc inside each chapter that needs a local TOC.
%-----------------------------------------------------------------------
%\etoctocstyle[⟨kind⟩]{⟨number_of_columns⟩}{⟨title⟩}
