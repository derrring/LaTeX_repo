...
\DeclarePairedDelimiterX\ensemble[1]\{\}{%
    \newcommand\given{\SetSymbol[\delimsize]}
    #1
}
...
%==============Category Theory================
\newcommand{\Hom}{\mathbf{Hom}} % for homomorphism
\newcommand{\Iso}{\mathbf{Iso}} % for isomorphism
\newcommand{\Aut}{\mathbf{Aut}} % for automorphism
\newcommand{\End}{\mathbf{End}} % for endomorphism
