...
%
% NOTE: Feature packages (e_title_fenced_sec, e_title_fenced_chap)
% define their own \titleformat for the levels they style. This hook
% must NOT overwrite those. We skip \section if e_title_fenced_sec is
% loaded, and \chapter if e_title_fenced_chap is loaded, so that
% feature-package formatting is preserved.
\makeatletter
